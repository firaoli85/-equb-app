// WhatsApp / SMS OTP login — disabled pending Meta template approval.
// Re-enable by uncommenting everything below and restoring the full LoginForm
// method picker (PIN + WhatsApp + SMS options).
...
// }
//
// // Called directly from LoginForm via plain async function — phone is already E.164
