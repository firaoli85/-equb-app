...
const STATUS_ICON: Record<Status, string> = { PAID: "✓", LATE: "!", PENDING: "−" };
...
export function MemberPaymentGrid({ members, weeks, payments }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
      ...
      {/* Legend */}
      <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-800 flex gap-5 text-xs text-gray-500 dark:text-gray-400">
